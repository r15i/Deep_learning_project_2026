...
% \red{This section should take max half a column, I personally find it difficult to come up with really useful observations, I mean ones that bring a new contribution with respect to what you have already expounded in the ``Results'' section..}\\
...
% \rev{\textbf{What I would like to see here is:} 
% \begin{enumerate}
